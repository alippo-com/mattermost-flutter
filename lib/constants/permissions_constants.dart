...
// This is a conversion from a TypeScript file to Dart for Flutter project usage.

/// Permissions constants for iOS used throughout the app.
const Map<String, String> iosPermissions = {
  'NSAppleMusicUsageDescription': 'Enabling access to your media library means you can attach files from your media library to your messages in {applicationName}.',
  ...
  'NSFaceIDUsageDescription': 'Enabling access to your Face ID means we can restrict unauthorized users from accessing {applicationName} on your device.',
  'NSLocationAlwaysUsageDescription': 'Enabling access to your location data means we can add location metadata to pictures and videos you share in {applicationName}.',
  'NSLocationWhenInUseUsageDescription': 'Enabling access to your location data means we can add location metadata to pictures and videos you share in {applicationName}.',
  'NSMicrophoneUsageDescription': 'Enabling access to your device's microphones means you can capture audio for calls or videos to share in {applicationName}.',
  'NSPhotoLibraryAddUsageDescription': 'Enabling write access to your photo library means you can save downloaded photos and videos from {applicationName} to your device.',
  ...
  'NSSpeechRecognitionUsageDescription': 'Enabling your device to send user data to Apple means you can send voice messages to {applicationName}.',
};

/// General permissions and roles used within the app.
const Map<String, dynamic> permissions = {
  'PERMISSIONS_ALL': 'all',
...
// CHANNEL_MODERATED_PERMISSIONS and other nested structures can be declared similarly if required.

...
import 'package:flutter_svg/flutter_svg.dart'; // Import flutter_svg package for SVG support

class SwipeLeftHand extends StatelessWidget {
  final String fillColor;

  SwipeLeftHand({required this.fillColor, Key? key}) : super(key: key);
